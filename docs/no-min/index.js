...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/common/components/currentYear.ts":[function(require,module,exports) {
"use strict";
...
var currentYear = function currentYear() {
  ...
  if (yearElement !== null) {
    ...
    yearElement.innerHTML = _currentYear.toString();
  }
};
...
},{}],"js/common/components/initAOS.ts":[function(require,module,exports) {
"use strict";
...
exports.default = initAOS;
},{"aos":"../node_modules/aos/dist/aos.js"}],"js/common/components/menuToggler.ts":[function(require,module,exports) {
"use strict";
...
var menuToggler = function menuToggler() {
  var headers = document.querySelectorAll('.header__contents');
  ...
  if (windowWidth < 1025 && headers) {
    headers.forEach(function (header) {
      ...
      toggler === null || toggler === void 0 ? void 0 : toggler.addEventListener('click', function () {
        ...
        nav === null || nav === void 0 ? void 0 : nav.classList.toggle('expand');
        updateBodyOverflow();
...
var currentYear_1 = __importDefault(require("./components/currentYear"));
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0, currentYear_1.default)();
}, false);
},{"./components/currentYear":"js/common/components/currentYear.ts","./components/initAOS":"js/common/components/initAOS.ts","./components/menuToggler":"js/common/components/menuToggler.ts","./components/modeSwitch":"js/common/components/modeSwitch.ts","./components/showElementsOnScroll":"js/common/components/showElementsOnScroll.ts"}]},{},["js/common/index.ts"], null)